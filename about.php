...
// تحديد المتغيرات الأساسية
 $pageTitle = "من نحن  - pspkg-arabic";
 $pageDescription = "تواصل مع فريق pspkg-arabic للحصول على الدعم أو طرح أي استفسارات حول ألعاب بلايستيشن.";
 $canonicalUrl = "https://arabic.com/contact.php";
